...
from filters import prev_next_filter_with_moving_objects_filter
...
if __name__ == '__main__':
  ...
  fixed_frames = prev_next_filter_with_moving_objects_filter(frames)

  display_side_by_side_video(frames, fixed_frames)
